...
const Movies = ({dt}) => {
  ...
  return (
    <div onClick={() => router.push(`/movie/${dt?.id}`)}
     className=' w-[470px] relative imgContainer cursor-pointer'>
       <Image alt='image' style={{objectFit: "cover"}} width={470} height={300} src={`https://image.tmdb.org/t/p/original/${dt?.backdrop_path || dt?.poster_path}`} />
